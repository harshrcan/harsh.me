...
export default {
  ...
  theme: {
    extend: {
      colors: {
        'portfolio-dark': '#06080d',
        'portfolio-dark-alt': '#0c1018',
        'portfolio-card': '#111827',
        'portfolio-card-hover': '#1a2235',
        'portfolio-border': '#1e293b',
        'portfolio-border-hover': '#334155',
        'portfolio-text': '#f1f5f9',
        'portfolio-text-secondary': '#94a3b8',
        'portfolio-text-muted': '#64748b',
        'portfolio-accent': '#818cf8',
        'portfolio-accent-hover': '#a5b4fc',
        'portfolio-purple': '#a78bfa',
        'portfolio-blue': '#60a5fa',
        'portfolio-emerald': '#34d399',
      },
      fontFamily: {
